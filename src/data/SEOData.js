...
export const PAGE_CONFIGS = {
  home: {
    title: 'UPStore - Sistemas UPS & Respaldo Energético Ecuador',
    description: 'UPStore Ecuador: Sistemas UPS monofásicos y trifásicos para centros de datos y empresas. Mini UPS especiales para routers, cámaras y dispositivos pequeños - ideales para crisis energética y uso continuo. UPS – Sistemas de Alimentación Ininterrumpida (SAI) desde 750VA hasta 200kVA para servidores y equipos críticos. Compra online con envío a Quito, Cuenca, Guayaquil, Samborondón y todo Ecuador. Marcas: APC by Schneider Electric, Vertiv, Eaton, Victron Energy. Protección profesional y doméstica contra cortes de energía.',
    keywords: [
      'ups ecuador comprar',
      ...
      'UPS – Sistemas de Alimentación Ininterrumpida (SAI) ecuador',
      'ups online ecuador',
      'ups APC by Schneider Electric ecuador',
      'ups eaton ecuador',
      'ups victron energy ecuador',
      'mantenimiento ups ecuador',
      'ups servidores ecuador',
      'protección energética ecuador',
      ...
      'Mini UPS 5A',
      'Mini UPS 1A',
      'venta ups guayaquil ecuador',
      'venta ups samborondon ecuador',
      'venta ups quito ecuador',
      'venta ups cuenca ecuador',
      'donde comprar ups ecuador',
      'ups trifásicos para empresas ecuador',
      'ups para servidores ecuador',
      'ups precio ecuador 2026',
      'mini ups crisis energética ecuador',
      'mini ups respaldo router conexión',
      'mini ups cámaras seguridad',
      'mini ups dispositivos pequeños'
    ],
